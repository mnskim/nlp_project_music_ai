...
# @register_model("roberta_custom")
# class RobertaModelCustom(FairseqEncoderModel):
#     @classmethod
#     def hub_models(cls):
#         return {
...
#         #if regression_head_name is not None:
...
#             head_name = k[len(prefix + "reagression_heads.") :].split(".")[0]
#             num_classes = state_dict[
...
class RobertaRegressionHead(nn.Module):
    """Head for sentence-level regression tasks.(M2PF) """
