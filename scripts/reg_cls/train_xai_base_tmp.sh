...
do
    ...
    for lr in "${PEAK_LRS[@]}"
        do
        CHECKPOINT_SUFFIX=xai_apex_M2PFnP_${size}_${lr}_tmp.pt
        fairseq-train xai_data_bin_apex_reg_cls/0 --user-dir musicbert \
            ...
            --tensorboard-logdir /data1/jongho/muzic/musicbert/checkpoints/board_apex_M2PFnP_${lr}_${size}_tmp \
