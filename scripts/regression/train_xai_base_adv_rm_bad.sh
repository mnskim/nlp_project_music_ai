...
WARMUP_UPDATES=300
PEAK_LRS=(0.0001 0.00001 0.000001)
...
do
    ...
    for lr in "${PEAK_LRS[@]}"
        do
        CHECKPOINT_SUFFIX=xai_apex_${lr}_${size}_M2PF_rm_bad_adv.pt
        fairseq-train xai_data_bin_apex_rm_bad/0 --user-dir musicbert \
            ...
            --tensorboard-logdir checkpoints/board_apex_${lr}_${size}_M2PF_rm_bad_adv \
