...
do
    ...
    for lr in "${PEAK_LRS[@]}"
        do
        CHECKPOINT_SUFFIX=xai_apex_M2PF_${lr}_${size}_16.pt
        fairseq-train processed/xai_data_bin_apex_reg_cls_16bars/0 --user-dir musicbert \
            ...
            --tensorboard-logdir checkpoints_16bars/M2PF/board_apex_${lr}_${size} \
            --best-checkpoint-metric R2 \
            --shorten-method "truncate" \
            --save-dir checkpoints_16bars \
