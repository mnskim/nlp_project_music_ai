...
do
    ...
    for lr in "${PEAK_LRS[@]}"
        do
        CHECKPOINT_SUFFIX=xai_apex_M2PF_${lr}_${size}_8.pt
        SAVE_DIR=checkpoints_8_16_match
        fairseq-train processed/subset_8_16/xai_data_bin_apex_8bars/0 --user-dir musicbert \
            ...
            --tensorboard-logdir ${SAVE_DIR}/M2PF/board_apex_${lr}_${size} \
