...
do
    ...
    for lr in "${PEAK_LRS[@]}"
        ...
        fairseq-train processed/xai_data_bin_apex_reg_cls_8bars/0 --user-dir musicbert \
            ...
            --tensorboard-logdir checkpoints_8bars/M2PF/board_apex_${lr}_${size} \
            --best-checkpoint-metric R2 \
            --shorten-method "truncate" \
            --save-dir checkpoints_8bars \
