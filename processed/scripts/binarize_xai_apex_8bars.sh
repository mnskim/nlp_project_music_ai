...
PREFIX=$1
i=0
src=${PREFIX}_data_raw_apex_reg_cls_8bars/$i
dest=${PREFIX}_data_bin_apex_reg_cls_8bars/$i
[[ -d "${PREFIX}_data_bin_apex_reg_cls_8bars" ]] && { echo "output directory ${PREFIX}_data_bin_apex_reg_cls_8bars already exists" ; exit 1; }
