...
PREFIX=$1
i=0
src=${PREFIX}_data_raw_apex_reg_cls_16bars/$i
dest=${PREFIX}_data_bin_apex_reg_cls_16bars/$i
[[ -d "${PREFIX}_data_bin_apex_reg_cls_16bars" ]] && { echo "output directory ${PREFIX}_data_bin_apex_reg_cls_16bars already exists" ; exit 1; }
