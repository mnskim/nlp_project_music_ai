...
PREFIX=$1
i=0
src=${PREFIX}_data_raw_apex_reg_cls_rm_highstd/$i
dest=${PREFIX}_data_bin_apex_reg_cls_rm_highstd/$i
[[ -d "${PREFIX}_data_bin_apex_reg_cls_rm_highstd" ]] && { echo "output directory ${PREFIX}_data_bin_apex_reg_cls_rm_highstd already exists" ; exit 1; }
